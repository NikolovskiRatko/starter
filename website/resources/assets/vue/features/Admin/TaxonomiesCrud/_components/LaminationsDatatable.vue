<script lang="ts">
    ...
    import { lamination } from '@/utils/Objects';
    ...
    export default class LaminationsDatatable extends Mixins(DragableDatatableMixin) {

      endpoint: string;
      datatable_data: LaminationTableRow[];
      lamination: LaminationTableRow;
      activeEditIndex: number|null;
      activeNewItem: boolean;

      constructor() {
          super();
          this.endpoint = 'common/laminations';
          this.datatable_data = [];
          ...
          this.form = new Form(cloneDeep(lamination));
      }
      ...
      addNewItem() {
        if (!this.activeNewItem) {
          this.datatable_data.push(cloneDeep(lamination));
          ...
          <dragable-datatable :columns="columns"
            ...
            <Container
              ...
              <Draggable
                ...
                <td class="edit-action-col" :style="'width:'+columns[4].width+';'">
