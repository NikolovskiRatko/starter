<script lang="ts">
    ...
    import { cliche } from '@/utils/Objects';
    ...
    export default class ClichesDatatable extends Mixins(DragableDatatableMixin) {

      endpoint: string;
      datatable_data: ClicheTableRow[];
      cliche: ClicheTableRow;
      activeEditIndex: number|null;
      activeNewItem: boolean;

      constructor() {
          super();
          this.endpoint = 'common/cliches';
          this.datatable_data = [];
          ...
          this.form = new Form(cloneDeep(cliche));
      }
      ...
      addNewItem() {
        if (!this.activeNewItem) {
          this.datatable_data.push(cloneDeep(cliche));
          ...
          <dragable-datatable v-if="!loading"
            ...
            <Container
              ...
              <Draggable
                ...
                <td class="edit-action-col" :style="'width:'+actions[0].width+';'">
